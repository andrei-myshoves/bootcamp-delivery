...
function SheetContent({
    ...
    desktopSide?: 'top' | 'right' | 'bottom' | 'left'
    ...
    const currentSide = isDesktop && desktopSide ? desktopSide : side
            ...
            >
                ...
                {showCloseButton && (
                    <SheetPrimitive.Close asChild>
                        <button
                            type="button"
                            className="absolute top-3 right-3 rounded-md p-2 opacity-70 transition-opacity hover:opacity-100"
                        >
